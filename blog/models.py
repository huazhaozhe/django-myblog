...
class Post(models.Model):
    ...
    def get_comments(self):
        comment_parent_list = self.comment_set.filter(parent_comment=None).order_by('created_time')
        comment_child_list = self.comment_set.exclude(parent_comment=None).order_by('created_time')
        comment_list = []
